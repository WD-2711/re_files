...
/* loaded from: r.class */
public class r extends com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.a {
    ...
    private boolean e() {
        try {
            ...
            Logger.i("QcOiClz", "pass check exception:", th);
            return false;
        }
    }
    ...
    @Override // com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.a
    public boolean d() {
        return Build.VERSION.SDK_INT >= 26 && Build.VERSION.SDK_INT <= 29 && e();
    }
}
