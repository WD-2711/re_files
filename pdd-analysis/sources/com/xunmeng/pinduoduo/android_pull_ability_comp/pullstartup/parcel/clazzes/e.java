...
/* loaded from: e.class */
public class e extends com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.a {
    ...
    private boolean e() {
        try {
            ParcelParaArr a2 = com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.b.a("HnAiClz", "config_pull_ability_dd_hnaiclz_64100");
            if (a2 == null || TextUtils.isEmpty(a2.paraIntArr)) {
                Logger.i("HnAiClz", "can't get para arr.");
                return false;
            }
            this.d = a2.paraIntArr;
            String a3 = com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.b.a(this.d);
            if (a3 == null) {
                Logger.i("HnAiClz", "clz name is null.");
                return false;
            }
            Class.forName(a3);
            Class.forName("com.hihonor.recsys.aidl.HwObjectContainer");
            return true;
        } catch (Throwable th) {
            Logger.i("HnAiClz", "pass check exception:", th);
            return false;
        }
    }
    ...
    public Bundle b(Intent intent) {
        ...
        obtain2.writeInt(6);
        obtain2.writeInt(4);
        obtain2.writeString("com.hihonor.recsys.aidl.HwObjectContainer");
        obtain2.writeSerializable(Intent.class);
        obtain2.writeInt(1);
        obtain2.writeInt(4);
