...
public class f {
    ...
    public static boolean b(boolean z) {
        try {
            ...
            if (!z) {
                ...
                com.xunmeng.pinduoduo.alive.base.ability.impl.startup.e.a(intent);
            } else {
                com.xunmeng.pinduoduo.alive.base.ability.impl.startup.b.c(intent);
            }
    ...
    public static boolean d() {
        if (i()) {
            ...
            boolean e2 = com.xunmeng.pinduoduo.alive.base.ability.impl.startup.b.e();
            Logger.i("LVBA.AliveModule.Provider.LauncherUtils", "can restart launcher by bg start: %s", new Object[]{Boolean.valueOf(e2)});
            return e2;
        }
        return true;
    }
