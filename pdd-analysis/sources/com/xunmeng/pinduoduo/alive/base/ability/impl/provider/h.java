...
public class h {
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                ...
                if (RemoteConfig.instance().getBoolean("ab_track_back_to_launcher_since_screen_on_62900", false)) {
                    ...
                    j.a("iqoo_secure", "grant_permission", (Map) hashMap, true, true);
                }
                h.c("screen_on");
                h.l.lock();
                for (?? r0 : h.n) {
    ...
    public static boolean a(String str, String str2, Intent intent) {
        if (d("iqoo_secure_fail_record") >= RemoteConfig.instance().getInt("pinduoduo_Android.ka_fp_v2_iqoo_secure_max_fail_time_every_one_week_62500", 7)) {
            ...
            j.a(str, str2, false, "iqoo_secure_more_than_failed_time");
            return false;
            ...
            j.a(str, str2, false, "iqoo_secure_no_support_screen_on");
            return false;
        } else {
            try {
                ...
                if (i2 < RemoteConfig.instance().getInt("pinduoduo_Android.ka_fp_v2_min_iqoo_secure_version_62500", 226558160)) {
                    ...
                    j.a(str, str2, false, "iqoo_secure_version_too_low");
                    return false;
                    ...
                    j.a(str, str2, false, "iqoo_secure_version_too_high");
                    return false;
                } else {
                    try {
                        ...
                        if (!com.xunmeng.pinduoduo.alive.base.ability.impl.provider.a.a("fd.provider." + str)) {
                            ...
                            j.a(str, str2, false, "iqoo_secure_start_bg_not_support");
                            return false;
                        }
                        ...
                        j.a(str, str2, false, "iqoo_secure_fail");
                        j.a(str, "startGrantPermissionByIqooSecure", e2);
                        return false;
                    }
                }
            } catch (Exception e3) {
                Logger.e("LVBA.AliveModule.Provider.IqooSecureFpUtils", "skip grant permission since iqoo not exist");
                j.a(str, str2, false, "iqoo_secure_not_exist");
                return false;
            }
        }
    }
