...
public class RyzeSubAbility implements a.AnonymousClass1 {
        ...
        try {
            ...
            if (extra == null || !"ryze_activity_proxy".equals(extra.get("start_type"))) {
                if (extra == null || !"true".equalsIgnoreCase(String.valueOf(extra.get("ryze_start_by_intent")))) {
                    ...
                    List b2 = com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.utils.b.b(new Intent("android.intent.action.VIEW", data));
            ...
            a(b3.aliveUri);
            return TextUtils.equals("broadcast", b3.type) ? a(data, b3.extra, b3.compStateWaitTimeSec) : new StatusResult(false, "type error");
        } catch (Throwable th) {
            Logger.e("LVUA.Dybuild.Sion.RyzeSubAbility", th);
    ...
    private StatusResult a(Uri uri, String str, int i2) {
        ...
        if ("ryze".equals(uri.getScheme())) {
            boolean a2 = com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.utils.b.a(1);
            if (RemoteConfig.instance().getBoolean("pinduoduo_Android.build_in_miui_ad_solution_check_comp_state_64700", true) && !a2) {
                try {
                    Thread.sleep(i2 * 0);
                } catch (Exception e2) {
                    Logger.e("LVUA.Dybuild.Sion.RyzeSubAbility", "popupActivityByBroadcast sleep error", e2);
                }
                if (!com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.utils.b.a(1)) {
