...
public class b extends BaseAbility implements a.AnonymousClass1 {
    ...
    public boolean isSupport() {
        try {
            ...
            if (map == null || map.isEmpty()) {
                ...
                return false;
            } else if (!com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.utils.b.d(b(a2))) {
    ...
    private Integer c(RumbleConfig rumbleConfig) {
        ...
        PackageInfo a2 = com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.utils.b.a(rumbleConfig.pkgName);
        if (a2 == null) {
    ...
    private int d(RumbleConfig rumbleConfig) {
        ...
        int i = a2.versionCode;
        Logger.i("LVUA.Buildin.RumbleStartAbility", "ability pkg version code: %d, version name: %s", new Object[]{Integer.valueOf(i), a2.versionName});
        return i;
    }
    ...
    private Intent a(Intent intent) {
        ...
        com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.utils.b.a(1);
