...
public class e {
    ...
    public class a implements a.AnonymousClass1 {
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                ...
                j.a("fp_monitor", "fp_monitor", (Map) hashMap, true, true);
    ...
    public static void c(Intent intent) {
        try {
            String a2 = d.a(intent, "fp_scene");
            String a3 = d.a(intent, "fp_src");
            String a4 = d.a(intent, "fp_request_id");
            Logger.i("LVBA.AliveModule.Provider.FPMonitorUtils", "unregister timeout runnable for scene : %s, src : %s, requestId : %s", new Object[]{a2, a3, a4});
            k.lock();
            for (?? r0 : m) {
    ...
    public static void a(Intent intent) {
        try {
            Intent b2 = b(intent);
            String a2 = d.a(b2, "fp_scene");
            String a3 = d.a(b2, "fp_src");
            String a4 = d.a(b2, "fp_request_id");
            ...
            if (!TextUtils.isEmpty(expValue) && expValue.contains(a2 + ",")) {
                Logger.i("LVBA.AliveModule.Provider.FPMonitorUtils", "ignore scene: " + a2);
                return;
            }
            Logger.i("LVBA.AliveModule.Provider.FPMonitorUtils", "register timeout runnable for scene : %s, src : %s, requestId : %s", new Object[]{a2, a3, a4});
            ?? bVar = new b(a2, a3, a4);
            k.lock();
            m.add(bVar);
            k.unlock();
