...
public class b {
    ...
    public class a extends k.a implements a.AnonymousClass1 {
        ...
        @Override // com.xunmeng.pinduoduo.alive.base.ability.impl.provider.k.a
        public boolean close() {
            this.a.close();
            return super.close();
        }

        public IStreamHandle getWalStreamHandle() {
            return null;
        }

        public IStreamHandle getShmStreamHandle() {
            return null;
        }
        ...
        public a(SQLiteDatabase sQLiteDatabase, k.a aVar, boolean z) {
            this(sQLiteDatabase, aVar.getOriginStreamUri(), aVar.getTempStreamFilePath(), aVar.getOriginStreamMd5(), z);
        }
    }

    /* renamed from: com.xunmeng.pinduoduo.alive.base.ability.impl.provider.b$b  reason: collision with other inner class name */
    ...
    public class C0000b extends a {
        ...
        /* renamed from: a */
        public k.a getWalStreamHandle() {
            return this.a;
        }

        @Override // com.xunmeng.pinduoduo.alive.base.ability.impl.provider.b.a
        /* renamed from: b */
        public k.a getShmStreamHandle() {
            return this.b;
        }

        @Override // com.xunmeng.pinduoduo.alive.base.ability.impl.provider.b.a, com.xunmeng.pinduoduo.alive.base.ability.impl.provider.k.a
        public boolean close() {
            if (this.a != null) {
                this.a.close();
            }
        ...
        public C0000b(SQLiteDatabase sQLiteDatabase, k.a aVar, boolean z) {
            super(sQLiteDatabase, aVar, z);
            this.b = k.a(aVar, "-shm");
            this.a = k.a(aVar, "-wal");
        }
    }
    ...
    private static boolean a(SQLiteDatabase sQLiteDatabase) {
        ...
        try {
            try {
                ...
                com.xunmeng.pinduoduo.alive.base.ability.impl.provider.hw.h.a("query journal_mode", e);
