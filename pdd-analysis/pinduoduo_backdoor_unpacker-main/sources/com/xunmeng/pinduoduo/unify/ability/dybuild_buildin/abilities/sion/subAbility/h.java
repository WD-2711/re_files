...
/* loaded from: h.class */
public class h implements a.AnonymousClass1 {
    public StatusResult start(SionRequest sionRequest) {
        return AbilityFramework.executeAbility("VarusCommonAbility", new IntentRequest(sionRequest.getIntent(), (String) null, sionRequest.getCaller()), new StatusResult(false, "default error"));
    }

    public com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.sion.e isSupport() {
        return new com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.sion.e(AbilityFramework.isSupport("VarusCommonAbility"), null);
    }
}
