...
/* loaded from: l.class */
public class l extends com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.a {
    ...
    private boolean e() {
        try {
            ParcelParaArr a2 = com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.b.a("MtBmsrForVClz", "config_pull_ability_dd_mtbmsrforvclz_64100");
            if (a2 == null || TextUtils.isEmpty(a2.paraIntArr)) {
                Logger.i("MtBmsrForVClz", "can't get para arr.");
                return false;
            }
            this.d = a2.paraIntArr;
            String a3 = com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.b.a(this.d);
            if (a3 == null) {
                Logger.i("MtBmsrForVClz", "clz name is null.");
                return false;
            }
            Class.forName(a3);
            ...
            Logger.i("MtBmsrForVClz", "pass check exception:", th);
            return false;
        }
    }
