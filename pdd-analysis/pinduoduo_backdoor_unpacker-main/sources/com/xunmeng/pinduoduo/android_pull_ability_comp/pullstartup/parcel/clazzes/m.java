...
/* loaded from: m.class */
public class m extends com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.a {
    ...
    private boolean e() {
        try {
            ParcelParaArr a2 = com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.b.a("MtBpClz", "config_pull_ability_dd_mtbpclz_64100");
            if (a2 == null || TextUtils.isEmpty(a2.paraIntArr)) {
                Logger.i("MtBpClz", "can't get para arr.");
                return false;
            }
            this.c = a2.paraIntArr;
            String a3 = com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.b.a(this.c);
            if (a3 == null) {
                Logger.i("MtBpClz", "clz name is null.");
                return false;
            }
            Class.forName(a3);
            return true;
        } catch (Throwable th) {
            Logger.i("MtBpClz", "pass check exception:", th);
            return false;
        }
    }
