...
/* loaded from: n.class */
public class n extends com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.a {
    ...
    private boolean e() {
        try {
            ...
            Logger.i("MtDdcrClz", "pass check exception:", th);
            return false;
        }
    }
    ...
    @Override // com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.parcel.a
    public boolean d() {
        return Build.VERSION.SDK_INT >= 26 && Build.VERSION.SDK_INT <= 30 && e();
    }
}
