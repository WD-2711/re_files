...
public class c {
    ...
    private static Boolean a(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            LogUtils.logExceptionErrorEvent("provider_oppo_ld", "isLockDisplayAbleFromDb", e);
            return null;
        }
    }
    ...
    private static String b(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                LogUtils.logEventAndErrorWithTracker("provider_oppo_ld", "emptyXml", (Map) new HashMap(), false, true);
                return null;
            }
            String f = f(str);
            ...
            LogUtils.logEventAndErrorWithTracker("provider_oppo_ld", "invalidXml", (Map) hashMap, false, true);
            return null;
        } catch (Exception e) {
            Logger.e("LVBA.AliveModule.Provider.oppoLD.LockDisplayUtils", "getLockDisplayPkgXml failed: ", e);
            LogUtils.logExceptionErrorEvent("provider_oppo_ld", "getLockDisplayPkgXml", e);
            return null;
        }
    }
    ...
    private static boolean a(SQLiteDatabase sQLiteDatabase, boolean z) {
        try {
            ...
            if (TextUtils.isEmpty(c)) {
                ...
                LogUtils.logEventAndErrorWithTracker("provider_oppo_ld", "invalidUpdatedXml", (Map) hashMap, false, true);
                return false;
            }
            ...
            LogUtils.logExceptionErrorEvent("provider_oppo_ld", "setLockDisplayToDb", e);
            return false;
        }
    }
