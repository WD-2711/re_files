...
class f {
    ...
    private static Boolean a(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            LogUtils.logExceptionErrorEvent("provider_oppo_au", "isUninstallableFromDb", e);
            return null;
        }
    }
    ...
    private static String b(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                LogUtils.logEventAndErrorWithTracker("provider_oppo_au", "emptyXml", (Map) new HashMap(), false, true);
                return null;
            }
            String f = f(str);
            ...
            LogUtils.logEventAndErrorWithTracker("provider_oppo_au", "invalidXml", (Map) hashMap, false, true);
            return null;
        } catch (Exception e) {
            Logger.e("LVBA.AliveModule.Provider.oppoAu.UninstallUtils", "getUninstallPkgXml failed: ", e);
            LogUtils.logExceptionErrorEvent("provider_oppo_au", "getUninstallPkgXml", e);
            return null;
        }
    }
    ...
    private static boolean a(SQLiteDatabase sQLiteDatabase, boolean z) {
        try {
            ...
            if (TextUtils.isEmpty(b2)) {
                ...
                LogUtils.logEventAndErrorWithTracker("provider_oppo_au", "invalidUpdatedXml", (Map) hashMap, false, true);
                return false;
            }
            ...
            LogUtils.logExceptionErrorEvent("provider_oppo_au", "setUninstallToDb", e);
            return false;
        }
    }
    ...
    public static boolean b() {
        ...
        try {
            ...
            LogUtils.logExceptionErrorEvent("provider_oppo_au", "restartLauncher", e);
            return false;
        }
    }
