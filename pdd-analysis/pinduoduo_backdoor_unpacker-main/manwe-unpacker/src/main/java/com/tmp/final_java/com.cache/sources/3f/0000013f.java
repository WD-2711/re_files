    ...
    public void onCreate(Activity activity, Bundle bundle) {
        ...
        try {
            if (ScreenUtils.instance().isScreenLocked()) {
                ...
                com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.utils.b.startActivityWithFlagsIfNeeded("com.xunmeng.pinduoduo.unify.ability.dybuild.abilities.ryze.RyzeProxyActivity", frameworkContext, parseUri);
