...
public class d {
    ...
    public static String d() {
        try {
            ...
            LogUtils.logExceptionErrorEvent("oppo_launcher_update", "getLauncherTable", e);
    ...
    private static boolean a(SQLiteDatabase sQLiteDatabase, int i) {
        try {
            ...
            LogUtils.logExceptionErrorEvent("oppo_launcher_update", "removeIconInner", e);
            return false;
        }
    }
    ...
    static int[] c() {
        ...
        try {
            setvalue = k.a(Uri.parse(h()));
            String tempStreamFilePath = setvalue.getTempStreamFilePath();
    ...
    private static boolean a(SQLiteDatabase sQLiteDatabase, OppoIconInfo oppoIconInfo) {
        ...
        try {
            ...
            LogUtils.logExceptionErrorEvent("oppo_launcher_update", "addIconInner", e);
            return false;
        }
    }
    ...
    private static List a(SQLiteDatabase sQLiteDatabase) {
        ...
        try {
            try {
                ...
                LogUtils.logExceptionErrorEvent("oppo_launcher_update", "getLauncherIconsInner", e);
                if (cursor != null) {
                    cursor.close();
                }
            }
    ...
    public static String i() {
        if (TextUtils.isEmpty(b)) {
            try {
                ...
                LogUtils.logExceptionErrorEvent("oppo_launcher_update", "getLauncherPkg", e);
            }
        }
        if (TextUtils.isEmpty(b)) {
