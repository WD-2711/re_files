...
public class d extends BaseBizProviderImpl implements a.AnonymousClass1 {
    ...
    public Boolean isUninstallable() {
        ...
        Boolean a = f.a();
        LogUtils.logInvokeResultEventAndError(getProviderScene(), "isUninstallable", a != null);
        if (a != null) {
    ...
    public boolean a() {
        ...
        boolean b2 = f.b();
        LogUtils.logRestartEventAndError(getProviderScene(), b2);
        return b2;
    }
    ...
    public boolean setUninstall(boolean z) {
        ...
        LogUtils.logInvokeResultEventAndError(getProviderScene(), "setUninstall", a);
        return a;
    }
}