...
public class a implements a.AnonymousClass1 {
    ...
    private StatusResult a(SionRequest sionRequest) {
        ...
        if (queryIntentActivitiesForComponentUtilsWithFilter == null || queryIntentActivitiesForComponentUtilsWithFilter.size() == 0) {
        ...
        if (queryIntentActivitiesForComponentUtilsWithFilter.size() != 1) {
            ResolveInfo resolveInfoForActivity = com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.utils.b.getResolveInfoForActivity(intent);
            if (resolveInfoForActivity == null) {
                return new StatusResult(false, "Illegal intent, resolveActivity is null");
            }
            ActivityInfo activityInfo2 = resolveInfoForActivity.activityInfo;
    ...
    private C0002a a(String str, SionRequest sionRequest, ActivityInfo activityInfo) {
        Application applicationIfSupported = com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.utils.b.getApplicationIfSupported();
        if (applicationIfSupported == 0 || activityInfo == null || !activityInfo.packageName.equals(StrategyFramework.getFrameworkContext().getPackageName())) {
            return null;
        }
        String str2 = activityInfo.name;
        Logger.i("LVUA.Dybuild.Sion.DefaultSionAbilityImpl", "activity name = " + str2);
        ?? c0002a = new C0002a(str, str2, sionRequest);
        applicationIfSupported.registerActivityLifecycleCallbacks(c0002a);
        return c0002a;
    }
    ...
    private ActivityInfo a(Intent intent) {
        ...
        return ((ResolveInfo) queryIntentActivitiesForComponentUtilsWithFilter.get(0)).activityInfo;
    }
    ...
    private void a(final C0002a c0002a, final String str, boolean z) {
        final Application applicationIfSupported = com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.utils.b.getApplicationIfSupported();
        if (applicationIfSupported == null) {
            return;
        }
        if (!z) {
            Logger.i("LVUA.Dybuild.Sion.DefaultSionAbilityImpl", "unregisterActivityLifecycle by fail");
            applicationIfSupported.unregisterActivityLifecycleCallbacks(c0002a);
            return;
        }
