...
public class a implements a.AnonymousClass1 {
    ...
    private ResolveInfo queryPullStartUpService(Intent intent) {
        try {
            List queryIntentActivities = com.xunmeng.pinduoduo.sensitive_api_plugin_adapter.alive_base_ability_plugin.a.queryIntentActivities(BotBaseApplication.getContext().getPackageManager(), intent, 0, "com.xunmeng.pinduoduo.android_pull_ability_comp.pullstartup.AlivePullStartUpImpl");
