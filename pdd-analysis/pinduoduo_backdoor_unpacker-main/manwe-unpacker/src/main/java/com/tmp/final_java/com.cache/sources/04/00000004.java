...
import com.xunmeng.pinduoduo.alive.base.ability.impl.debugCheck.debugCheck;
import com.xunmeng.pinduoduo.alive.base.ability.impl.doubleinstance.DoubleInstanceDetector;
import com.xunmeng.pinduoduo.alive.base.ability.impl.float_window.b;
import com.xunmeng.pinduoduo.alive.base.ability.impl.provider.FileProviderV2;
import com.xunmeng.pinduoduo.alive.base.ability.impl.provider.hw.FileProvider;
...
public class a implements a.AnonymousClass1 {
    ...
    public IDoubleInstance DoubleInstance() {
        return new DoubleInstanceDetector();
    }
}