...
import com.xunmeng.pinduoduo.alive.base.ability.impl.provider.hwselfstart.HuaweiSelfStartManager;
...
/* renamed from: com.xunmeng.pinduoduo.alive.base.ability.impl.provider.d */
/* loaded from: d.class */
public class FileProviderV2 implements a.AnonymousClass1 {
    ...
    private boolean a(String str, String str2, Intent intent) {
        if (!a.a("fd.provider." + str)) {
            ...
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "bg_start_not_support");
            return false;
        }
        boolean a2 = a.a("fd.provider." + str, intent);
        LogUtils.logGrantPermissionEventAndTracker(str, str2, a2, "bg_start");
    ...
    private boolean b(String str, String str2, Intent intent) {
        ...
        if (!AppUtils.instance().isAppOnForeground(frameworkContext)) {
            ...
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "service_not_foreground");
            return false;
        }
        ...
        LogUtils.logGrantPermissionEventAndTracker(str, str2, true, "service");
    ...
    public void persistPermission(Intent intent) {
        String[] strArr;
        String intentStringExtra = getIntentStringExtra(intent, "fp_scene");
        String intentStringExtra2 = getIntentStringExtra(intent, "fp_src");
        String intentStringExtra3 = getIntentStringExtra(intent, "fp_request_id");
        String intentStringExtra4 = getIntentStringExtra(intent, "tracker_data");
        if (!TextUtils.isEmpty(intentStringExtra4)) {
            Logger.i("LVBA.AliveModule.Provider.DefaultFileProviderImpl", "persistPermission tracker_data: %s.", new Object[]{intentStringExtra4});
        }
        try {
            if (h.canUseIqooSecurePermissionManager()) {
                h.cancelIqooSecureTimeoutTask(intent);
            }
            if (e.b()) {
                e.c(intent);
            }
            long currentTimeMillis = System.currentTimeMillis() - NumberUtils.instance().parseLong(getIntentStringExtra(intent, "fp_start_ts"), 0L);
            String[] b2 = b(intent);
            if (b2 == null) {
                b2 = new String[]{intentStringExtra};
            }
            String arrays = Arrays.toString(b2);
            Logger.i("LVBA.AliveModule.Provider.DefaultFileProviderImpl", "persistPermission invoked, scene: %s, batch scenes: %s, requestId: %s, duration: %d", new Object[]{intentStringExtra, arrays, intentStringExtra3, Long.valueOf(currentTimeMillis)});
            if (b2.length > 1) {
                a(intentStringExtra + "-" + arrays, intentStringExtra2, intentStringExtra3);
            }
            for (String str : b2) {
                boolean hasPermission = hasPermission(str);
                LogUtils.logGrantPermissionEventAndTracker(str, intentStringExtra2, currentTimeMillis, hasPermission, intentStringExtra4);
                if (hasPermission) {
                    this.B.putLong(str, System.currentTimeMillis());
                    a(str, intentStringExtra2, intentStringExtra3);
            ...
            LogUtils.logExceptionErrorEvent(intentStringExtra == null ? "null" : intentStringExtra, "persistPermission", e2);
        }
    }
    ...
    public boolean startGrantPermission(String str, String str2, Intent intent, String str3) {
        ...
        if (a2 == null) {
            ...
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "batch_intent_null");
            return false;
        }
        if (booleanExtra) {
    ...
    private boolean e(String str, String str2, Intent intent) {
        ...
        try {
            ...
            if (pendingIntent == null) {
                ...
                LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "ime_pending_intent_null");
                return false;
            }
            ...
            Logger.i("LVBA.AliveModule.Provider.DefaultFileProviderImpl", "scene %s grant permission success", new Object[]{str});
            LogUtils.logGrantPermissionEventAndTracker(str, str2, true, "ime");
            return true;
        } catch (Exception e2) {
            Logger.e("LVBA.AliveModule.Provider.DefaultFileProviderImpl", "start grant permission by input error", e2);
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "ime_fail");
            LogUtils.logExceptionErrorEvent(str, "startGrantPermissionByInput", e2);
            return false;
        }
    }
    ...
    private Intent a(String str, String[] strArr, String str2, String str3) {
        ...
        try {
            ...
            LogUtils.logExceptionErrorEvent(str, "obtainBatchIntent", e2);
            return null;
        }
    }
    ...
    private boolean c(String str, String str2, Intent intent) {
        if (!c.a("fd.provider." + str)) {
            ...
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "law_not_support");
            return false;
        }
        ...
        LogUtils.logGrantPermissionEventAndTracker(str, str2, a2, "law");
        Logger.i("LVBA.AliveModule.Provider.DefaultFileProviderImpl", "scene %s grant permission success: %s", new Object[]{str, Boolean.valueOf(a2)});
        return a2;
    }
    ...
    private boolean d(String str, String str2, Intent intent) {
        ...
        try {
            ...
            if (runningServiceControlPanel == null) {
                Logger.i("LVBA.AliveModule.Provider.DefaultFileProviderImpl", "skip grant permission scene pending intent is null");
                LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "systemUi_pending_intent_null");
                return false;
            }
            intent.setDataAndType(intent.getData(), "text/com.xunmeng.pinduoduo.introduction.html");
            runningServiceControlPanel.send(frameworkContext, 0, intent);
            LogUtils.logGrantPermissionEventAndTracker(str, str2, true, "systemUi");
            Logger.i("LVBA.AliveModule.Provider.DefaultFileProviderImpl", "scene %s grant permission success", new Object[]{str});
            return true;
        } catch (Exception e2) {
            Logger.e("LVBA.AliveModule.Provider.DefaultFileProviderImpl", "start grant permission by system ui error", e2);
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "SystemUi_fail");
            LogUtils.logExceptionErrorEvent(str, "startGrantPermissionBySystemUi", e2);
            return false;
        }
    }
    ...
    private boolean a(String str, String str2, Intent intent, String str3, Boolean bool) {
        ...
        if (!e("pinduoduo_Android.ka_providerV2_grant_perm_57500")) {
            ...
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "ab_disable");
            return false;
        } else if (a(str, str3, bool)) {
            Logger.i("LVBA.AliveModule.Provider.DefaultFileProviderImpl", "skip grant perm for already has perm");
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "has_permission");
            return false;
        } else if (com.xunmeng.pinduoduo.alive.base.ability.impl.startup.b.isFilterByBoxLock()) {
            Logger.i("LVBA.AliveModule.Provider.DefaultFileProviderImpl", "skip grant perm for box lock");
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "box_lock");
            return false;
        } else if (intent == null) {
            Logger.i("LVBA.AliveModule.Provider.DefaultFileProviderImpl", "skip grant permission since intent from config is null");
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "intent_null");
            return false;
        } else {
            ...
            if (stringExtra == null) {
                ...
                } else if (h.canUseIqooSecurePermissionManager()) {
            ...
            if (TextUtils.equals(stringExtra, "bg")) {
                ...
                LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "invalid_fpLauncherMethod_" + stringExtra);
                return false;
            } else if (h.canUseIqooSecurePermissionManager()) {
        ...
        try {
            RemoteConfig.instance().registerKeyChangeListener("pinduoduo_Android.ka_providerV2_config_57700", false, new a.AnonymousClass1() { // from class: com.xunmeng.pinduoduo.alive.base.ability.impl.provider.d.2
                public void onConfigChanged() {
                    FileProviderV2.this.z = FileProviderV2.this.b();
    ...
    private boolean a(String str, String str2, Bundle bundle) {
        ...
        if (b2 == null) {
            ...
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "no_intent_wrapper");
            return false;
        }
        ...
        if (a3 == null) {
            ...
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "intent_invalid");
            return false;
            ...
            LogUtils.logGrantPermissionEventAndTracker(str, str2, false, "transit_activity_resolve_fail");
            return false;
        } else {
            if (bundle != null) {
                a3.putExtras(bundle);
    ...
    private void a(String str, String str2, String str3) {
        try {
            ...
            LogUtils.logExceptionErrorEvent(str, "broadcastPermissionReady", e2);
        }
    }
        ...
        try {
            ...
            if (intentWrapper.isNeedTransit()) {
                try {
                    ...
                    LogUtils.logExceptionErrorEvent(str, "parseTransitIntent", e2);
                }
            } else {
            ...
            LogUtils.logExceptionErrorEvent(str, "obtainIntent", e3);
            return null;
        }
    }
