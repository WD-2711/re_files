...
public class a extends BaseAbility implements a.AnonymousClass1 {
    ...
    private int d(JumpBoxInfo jumpBoxInfo) {
        ...
        PackageInfo packageInfoForPackageName = b.getPackageInfoForPackageName(jumpBoxInfo.jumpBoxPkgName);
        if (packageInfoForPackageName == null) {
            Logger.i("LVUA.Buildin.JumpBoxAbility", "pkg not installed, ability not support");
            return -1;
        }
        this.b = Integer.valueOf(packageInfoForPackageName.versionCode);
        Logger.i("LVUA.Buildin.JumpBoxAbility", "ability pkg version code: %d, version name: %s", new Object[]{this.b, packageInfoForPackageName.versionName});
        return this.b.intValue();
    }
}