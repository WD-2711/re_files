...
class f {
    ...
    private static boolean a(SQLiteDatabase sQLiteDatabase, int i2, int i3, int i4, e.setValue setvalue, Map map) {
        List a2 = a(sQLiteDatabase, String.format("%s=? and %s=? and %s=? and %s=-100", "cellX", "cellY", "screen", "container"), new String[]{String.valueOf(i2), String.valueOf(i3), String.valueOf(i4)}, setvalue, map);
        if (a2 == null) {
    ...
    public static boolean a(int i2, int i3) {
        b.a a2 = com.xunmeng.pinduoduo.alive.base.ability.impl.provider.b.a(Uri.parse(a(a.LAUNCHER_DATABASE_PATH_TEMPLATE)));
        if (a2 == null) {
            return false;
        }
    ...
    private static List a(SQLiteDatabase sQLiteDatabase, String str, String[] strArr, e.setValue setvalue, Map map) {
        if (setvalue == null || map == null) {
            return a(sQLiteDatabase, str, strArr);
        }
        String str2 = setvalue.e;
        ...
        try {
            ...
            EventLogger.logExceptionEvent("queryIcons", e2);
            return null;
        }
    }
    ...
    static boolean e() {
        ...
        if (TextUtils.isEmpty(configValue)) {
            ...
            return false;
        } else if (!isDefaultLauncherVersionGreaterOrEqual(configValue)) {
            return false;
        } else {
    ...
    private static boolean a(SQLiteDatabase sQLiteDatabase, IconInfo iconInfo, e.setValue setvalue, boolean z) {
        ...
        if (!c.s.contains(Integer.valueOf(iconInfo.getItemType()))) {
            ...
            try {
                ...
                EventLogger.logExceptionEvent("parseIntent", e2);
                return false;
            }
        }
        if (!c.q.contains(Integer.valueOf(iconInfo.getItemType()))) {
            ...
            return false;
        } else if (!(iconInfo.getItemType() == 10 && (iconInfo.getSpanX() == 0 || iconInfo.getSpanY() == 0)) && (iconInfo.getSpanX() <= 0 || iconInfo.getSpanX() > setvalue.d || iconInfo.getSpanY() <= 0 || iconInfo.getSpanY() > setvalue.c)) {
            Logger.e("LVBA.AliveModule.Provider.LauncherUtils", "spanX: %d, spanY: %d not valid, layout: %s", new Object[]{Integer.valueOf(iconInfo.getSpanX()), Integer.valueOf(iconInfo.getSpanY()), setvalue.b});
            return false;
        } else {
            Map b2 = b(sQLiteDatabase, setvalue.a);
            if (b2 == null) {
                return false;
            }
            if (iconInfo.getContainerId() == -100 && !b2.containsKey(Integer.valueOf(iconInfo.getScreen()))) {
                ...
                if (iconInfo.getCellX() < 0 || iconInfo.getCellX() >= setvalue.d || iconInfo.getCellY() < 0 || iconInfo.getCellY() >= setvalue.c) {
                    Logger.e("LVBA.AliveModule.Provider.LauncherUtils", "cellX: %d, cellY: %d not valid, layout: %s", new Object[]{Integer.valueOf(iconInfo.getCellX()), Integer.valueOf(iconInfo.getCellY()), setvalue.b});
                    return false;
                } else if (z && iconInfo.getContainerId() <= 0 && (iconInfo.getItemType() != 4 || iconInfo.getContainerId() != -100)) {
                    return a(sQLiteDatabase, iconInfo.getCellX(), iconInfo.getCellY(), iconInfo.getScreen(), setvalue, b2);
                } else {
    ...
    private static Integer a(SQLiteDatabase sQLiteDatabase) {
        e.setValue buildSetValueInstanceFromXML = e.buildSetValueInstanceFromXML();
        if (buildSetValueInstanceFromXML == null || TextUtils.isEmpty(buildSetValueInstanceFromXML.e)) {
            Logger.e("LVBA.AliveModule.Provider.LauncherUtils", "addScreen invalid layoutBaseInfo");
            return null;
        }
        Map b2 = b(sQLiteDatabase, buildSetValueInstanceFromXML.a);
        if (b2 == null) {
        ...
        try {
            ...
            contentValues.put("launcherType", Integer.valueOf(buildSetValueInstanceFromXML.a));
            ...
            EventLogger.logExceptionEvent("addScreen", e2);
            return null;
        }
    }
    ...
    public static boolean b(boolean z) {
        try {
            String huaweiOrHonorDefaultLauncherPackageName = getHuaweiOrHonorDefaultLauncherPackageName();
            Intent intent = new Intent();
            intent.setPackage(huaweiOrHonorDefaultLauncherPackageName);
            ...
            Logger.i("LVBA.AliveModule.Provider.LauncherUtils", "restart launcher finish, pkg: %s, bg start: %s", new Object[]{huaweiOrHonorDefaultLauncherPackageName, Boolean.valueOf(z)});
            return true;
        } catch (Exception e2) {
            Logger.e("LVBA.AliveModule.Provider.LauncherUtils", "fail to restartLauncher", e2);
            EventLogger.logExceptionEvent("restartLauncher", e2);
            return false;
        }
    }
    ...
    private static Map b(SQLiteDatabase sQLiteDatabase, int i2) {
        ...
        try {
            ...
            EventLogger.logExceptionEvent("queryScreenMap", e2);
            return null;
        }
    }
    ...
    private static boolean a(SQLiteDatabase sQLiteDatabase, int i2, int i3) {
        ...
        if (!TextUtils.isEmpty(e2) && c(sQLiteDatabase, i3)) {
            try {
                ...
                EventLogger.logExceptionEvent("moveToFolder", e3);
                return false;
            }
        }
        return false;
    ...
    /* renamed from: b */
    static boolean isDefaultLauncherVersionGreaterOrEqual(String str) {
        String huaweiDefaultLauncherPackageName = g.getHuaweiDefaultLauncherPackageName();
        if (TextUtils.isEmpty(huaweiDefaultLauncherPackageName)) {
            Logger.i("LVBA.AliveModule.Provider.LauncherUtils", "invalid launcher version, isBeyondTargetVersion=false");
            return false;
        }
        return g.compareVersion(huaweiDefaultLauncherPackageName, str);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a */
    public static String getHuaweiOrHonorDefaultLauncherPackageName() {
    ...
    private static boolean a(SQLiteDatabase sQLiteDatabase, IconInfo iconInfo) {
        e.setValue buildSetValueInstanceFromXML = e.buildSetValueInstanceFromXML();
        if (buildSetValueInstanceFromXML != null) {
            String str = buildSetValueInstanceFromXML.e;
            if (!TextUtils.isEmpty(str)) {
                if (!a(sQLiteDatabase, iconInfo, buildSetValueInstanceFromXML, true)) {
                ...
                try {
                    ...
                    EventLogger.logExceptionEvent("addIcon", e2);
                    return false;
                }
            }
        }
    ...
    public static String a(String str) {
        return String.format(str, Integer.valueOf(Process.myUserHandle().hashCode()), getHuaweiOrHonorDefaultLauncherPackageName());
    }
    ...
    private static boolean b(SQLiteDatabase sQLiteDatabase, IconInfo iconInfo) {
        ...
        try {
            ...
            EventLogger.logExceptionEvent("moveOutFolder", e3);
            return false;
        }
    }
    ...
    private static boolean c(SQLiteDatabase sQLiteDatabase, IconInfo iconInfo) {
        ...
        if (buildSetValueInstanceFromXML != null) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                if (!a(sQLiteDatabase, iconInfo, buildSetValueInstanceFromXML, z)) {
                ...
                try {
                    ...
                    EventLogger.logExceptionEvent("updateIcon", e2);
                    return false;
                }
            }
        }
    ...
    private static List a(SQLiteDatabase sQLiteDatabase, String str, String[] strArr) {
        ...
        Map b2 = b(sQLiteDatabase, buildSetValueInstanceFromXML.a);
        if (b2 != null) {
            return a(sQLiteDatabase, str, strArr, buildSetValueInstanceFromXML, b2);
        }
        return null;
    }
    ...
    private static boolean d(SQLiteDatabase sQLiteDatabase, int i2) {
        ...
        try {
            ...
            EventLogger.logExceptionEvent("removeIcon", e3);
            return false;
        }
    }
    ...
    public static boolean f() {
        boolean z;
        boolean huaweiFingerPrintParallelRestartSetting = getHuaweiFingerPrintParallelRestartSetting();
        final boolean i2 = i();
        boolean z2 = RemoteConfig.instance().getBoolean("pinduoduo_Android.hw_fp_monitor_launcher_death_61500", false) && huaweiFingerPrintParallelRestartSetting;
        Logger.i("LVBA.AliveModule.Provider.LauncherUtils", "restartLauncher, parallel: %s, bg: %s, monitorLauncherDeath: %s", new Object[]{Boolean.valueOf(huaweiFingerPrintParallelRestartSetting), Boolean.valueOf(i2), Boolean.valueOf(z2)});
        boolean z3 = false;
        if (z2) {
            z3 = d.a(getHuaweiOrHonorDefaultLauncherPackageName());
        }
        if (!huaweiFingerPrintParallelRestartSetting) {
            z = b(i2);
        } else {
    ...
    /* renamed from: h */
    private static boolean getHuaweiFingerPrintParallelRestartSetting() {
