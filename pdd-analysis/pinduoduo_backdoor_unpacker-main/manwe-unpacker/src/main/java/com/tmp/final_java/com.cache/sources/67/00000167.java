...
public class j implements a.AnonymousClass1 {
    ...
    public StatusResult start(SionRequest sionRequest) {
        com.xunmeng.pinduoduo.unify.ability.dybuild_buildin.abilities.utils.b.startActivityWithFlagsIfNeeded("com.xunmeng.pinduoduo.unify.ability.dybuild.abilities.sion.subAbility.VivoOverlaySubAbility", StrategyFramework.getFrameworkContext(), sionRequest.getIntent());
